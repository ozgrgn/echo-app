<script lang="ts">
	import { CATEGORIES, CATEGORY_LIST, TOTAL_WEIGHT, gpiZone, bayesianSmooth } from '@talkwo/echo-core';
...
<main class="min-h-screen bg-bg p-8">
	<div class="max-w-3xl mx-auto space-y-8">
		<header>
			<h1 class="text-3xl font-extrabold text-brand">ECHO Panel</h1>
		...
		<!-- Test 2: @talkwo/echo-core import -->
		<section class="bg-surface-1 border border-border rounded-lg p-6 shadow-sm">
			<h2 class="text-lg font-semibold mb-4">2. @talkwo/echo-core workspace import</h2>
