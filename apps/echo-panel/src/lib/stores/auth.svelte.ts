 ...
 * hoops-panel's own auth store feeds the JWT/identity into <EchoProvider>.
 *
...
import type { AuthCredentials } from '@talkwo/echo-ui';
...
function createAuth() {
	...
	return {
		...
		updateSubscription(subscription: EchoSubscription | null) {
			state.subscription = subscription;
		},
