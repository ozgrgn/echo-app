...
<script lang="ts">
	...
	let { overallRate, medianHours, byPlatform, bySentiment, competitorAvgRate }: Props = $props();
...
<div class="grid grid-cols-1 gap-4 lg:grid-cols-[auto_1fr_1fr]">
	...
	<div class="flex flex-col justify-center gap-2 lg:pr-4 lg:border-r lg:border-border">
		<div>
			<div class="text-[10.5px] font-bold uppercase tracking-wide text-text-3">Genel yanıt oranı</div>
