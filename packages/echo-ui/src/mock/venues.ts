...
// Includes 2 owned (a fictional chain) so the login multi-venue picker is exercised,
// + 1 competitor flagged isOwned:false so competitor scope rules can be tested.
export const MOCK_VENUES: Venue[] = [
	{
		venueId: '6a08aa75b2f780ab0c068737',
		slug: 'aurelia-bay-resort',
		name: 'Aurelia Bay Resort & Spa',
		platforms: {
	...
	},
	{
		...
		slug: 'aurelia-bay-belek',
		name: 'Aurelia Bay Belek',
		platforms: {
